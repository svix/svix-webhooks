...
func (e *EventType) list(options FetchOptions) (*ListResponseEventTypeInOut, error) {
	req := e.api.EventTypeApi.ListEventTypesApiV1EventTypeGet(context.TODO())
...
func (e *EventType) Create(eventTypeInOut *EventTypeInOut) (*EventTypeInOut, error) {
	req := e.api.EventTypeApi.CreateEventTypeApiV1EventTypePost(context.TODO())
...
func (e *EventType) Update(eventTypeName string, eventTypeUpdate *EventTypeUpdate) (*EventTypeInOut, error) {
	req := e.api.EventTypeApi.UpdateEventTypeApiV1EventTypeEventTypeNamePut(context.TODO(), eventTypeName)
...
func (e *EventType) Delete(eventTypeName string) error {
	req := e.api.EventTypeApi.DeleteEventTypeApiV1EventTypeEventTypeNameDelete(context.TODO(), eventTypeName)
	_, err := req.Execute()
	return err
}
