...
func (application *Application) List(
	...
	var err error
	if o != nil {
		internal.SerializeParamToMap("excludeAppsWithNoEndpoints", o.ExcludeAppsWithNoEndpoints, queryMap, &err)
		internal.SerializeParamToMap("excludeAppsWithDisabledEndpoints", o.ExcludeAppsWithDisabledEndpoints, queryMap, &err)
