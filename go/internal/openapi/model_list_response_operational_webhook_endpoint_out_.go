...
func NewListResponseOperationalWebhookEndpointOut(data []OperationalWebhookEndpointOut, done bool) *ListResponseOperationalWebhookEndpointOut {
...
func (o *ListResponseOperationalWebhookEndpointOut) HasIterator() bool {
...
func (o *ListResponseOperationalWebhookEndpointOut) SetIteratorNil() {
	o.Iterator.Set(nil)
}

// UnsetIterator ensures that no value is present for Iterator, not even an explicit nil
func (o *ListResponseOperationalWebhookEndpointOut) UnsetIterator() {
	o.Iterator.Unset()
}
