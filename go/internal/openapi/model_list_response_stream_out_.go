...
func NewListResponseStreamOut(data []StreamOut, done bool) *ListResponseStreamOut {
...
func (o *ListResponseStreamOut) HasIterator() bool {
...
func (o *ListResponseStreamOut) SetIteratorNil() {
	o.Iterator.Set(nil)
}

// UnsetIterator ensures that no value is present for Iterator, not even an explicit nil
func (o *ListResponseStreamOut) UnsetIterator() {
	o.Iterator.Unset()
}
