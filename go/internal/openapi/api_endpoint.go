...
type ApiResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostRequest struct {
	ctx _context.Context
	ApiService *EndpointApiService
	appId string
	endpointId string
...
func (r ApiResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostRequest) RecoverIn(recoverIn RecoverIn) ApiResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostRequest {
	r.recoverIn = &recoverIn
	return r
}

func (r ApiResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
	return r.ApiService.ResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostExecute(r)
}

/*
 * ResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPost Resend Failed Webhooks
 * Resend all failed messages since a given time.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param appId
 * @param endpointId
 * @return ApiResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostRequest
 */
func (a *EndpointApiService) ResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPost(ctx _context.Context, appId string, endpointId string) ApiResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostRequest {
	return ApiResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
 ...
 */
func (a *EndpointApiService) ResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostExecute(r ApiResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPostRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointApiService.ResendFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
