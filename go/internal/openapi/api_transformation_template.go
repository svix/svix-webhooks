...
func (r ApiV1TransformationTemplateOauthDiscordRequest) Execute() (*OauthPayloadOut, *http.Response, error) {
...
func (a *TransformationTemplateAPIService) V1TransformationTemplateOauthDiscordExecute(r ApiV1TransformationTemplateOauthDiscordRequest) (*OauthPayloadOut, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiV1TransformationTemplateOauthSlackRequest) Execute() (*OauthPayloadOut, *http.Response, error) {
...
// Execute executes the request
//  @return OauthPayloadOut
func (a *TransformationTemplateAPIService) V1TransformationTemplateOauthSlackExecute(r ApiV1TransformationTemplateOauthSlackRequest) (*OauthPayloadOut, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
