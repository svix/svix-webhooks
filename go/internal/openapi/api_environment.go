...
func (r ApiV1EnvironmentExportGetRequest) Execute() (*EnvironmentOut, *http.Response, error) {
...
*/
func (a *EnvironmentAPIService) V1EnvironmentExportGet(ctx context.Context) ApiV1EnvironmentExportGetRequest {
	return ApiV1EnvironmentExportGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return EnvironmentOut
func (a *EnvironmentAPIService) V1EnvironmentExportGetExecute(r ApiV1EnvironmentExportGetRequest) (*EnvironmentOut, *http.Response, error) {
	var (
