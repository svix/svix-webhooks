...
func (r ApiV1AuthenticationCreateMessageTokenRequest) Execute() (AuthTokenOut, *_nethttp.Response, error) {
 ...
 */
func (a *AuthenticationApiService) V1AuthenticationCreateMessageToken(ctx _context.Context, appId string) ApiV1AuthenticationCreateMessageTokenRequest {
	return ApiV1AuthenticationCreateMessageTokenRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
 ...
 * @return AuthTokenOut
 */
func (a *AuthenticationApiService) V1AuthenticationCreateMessageTokenExecute(r ApiV1AuthenticationCreateMessageTokenRequest) (AuthTokenOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
