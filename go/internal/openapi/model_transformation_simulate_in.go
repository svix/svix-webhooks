...
// checks if the TransformationSimulateIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransformationSimulateIn{}
...
type _TransformationSimulateIn TransformationSimulateIn
...
func (o *TransformationSimulateIn) UnmarshalJSON(data []byte) (err error) {
	...
	varTransformationSimulateIn := _TransformationSimulateIn{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransformationSimulateIn)

	if err != nil {
		return err
	}

	*o = TransformationSimulateIn(varTransformationSimulateIn)
