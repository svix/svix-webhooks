...
type BackgroundTaskOut struct {
	Data BackgroundTaskData `json:"data"`
	Id string `json:"id"`
...
func NewBackgroundTaskOut(data BackgroundTaskData, id string, status BackgroundTaskStatus, task BackgroundTaskType) *BackgroundTaskOut {
...
func (o *BackgroundTaskOut) GetData() BackgroundTaskData {
	if o == nil {
		var ret BackgroundTaskData
		return ret
	}
...
func (o *BackgroundTaskOut) GetDataOk() (*BackgroundTaskData, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Data, true
...
func (o *BackgroundTaskOut) SetData(v BackgroundTaskData) {
	o.Data = v
}
