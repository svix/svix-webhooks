...
func NewRecoverOut(id string, status BackgroundTaskStatus) *RecoverOut {
	this := RecoverOut{}
	this.Id = id
	this.Status = status
	var task string = "endpoint.recover"
	this.Task = &task
	return &this
}
...
func (o *RecoverOut) GetTask() string {
	if o == nil || o.Task == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RecoverOut) GetTaskOk() (*string, bool) {
	if o == nil || o.Task == nil {
		return nil, false
	}
	return o.Task, true
...
func (o *RecoverOut) HasTask() bool {
	if o != nil && o.Task != nil {
		return true
	}
...
func (o *RecoverOut) SetTask(v string) {
	o.Task = &v
}
