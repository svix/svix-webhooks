...
// checks if the EndpointStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EndpointStats{}
...
type _EndpointStats EndpointStats
...
func (o *EndpointStats) UnmarshalJSON(data []byte) (err error) {
	...
	varEndpointStats := _EndpointStats{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEndpointStats)

	if err != nil {
		return err
	}

	*o = EndpointStats(varEndpointStats)
