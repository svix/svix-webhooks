...
func (o *IntegrationUpdate) GetFeatureFlags() []string {
...
func (o *IntegrationUpdate) GetFeatureFlagsOk() ([]string, bool) {
	if o == nil || IsNil(o.FeatureFlags) {
		return nil, false
	}
...
func (o *IntegrationUpdate) HasFeatureFlags() bool {
	if o != nil && !IsNil(o.FeatureFlags) {
		return true
	}
...
func (o *IntegrationUpdate) SetFeatureFlags(v []string) {
	o.FeatureFlags = v
}
