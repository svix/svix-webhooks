...
func (a *MessageAttemptAPIService) V1MessageAttemptListByEndpointExecute(r ApiV1MessageAttemptListByEndpointRequest) (*ListResponseMessageAttemptOut, *http.Response, error) {
	...
	if r.statusCodeClass != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "status_code_class", r.statusCodeClass, "")
	}
	if r.channel != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "channel", r.channel, "")
	}
	...
	if r.withMsg != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "with_msg", r.withMsg, "")
	} else {
...
func (a *MessageAttemptAPIService) V1MessageAttemptListByMsgExecute(r ApiV1MessageAttemptListByMsgRequest) (*ListResponseMessageAttemptOut, *http.Response, error) {
	...
	if r.endpointId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "endpoint_id", r.endpointId, "")
	}
	if r.before != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "before", r.before, "")
	}
