...
// checks if the MessageAttemptOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MessageAttemptOut{}
...
type _MessageAttemptOut MessageAttemptOut
...
func (o *MessageAttemptOut) UnmarshalJSON(data []byte) (err error) {
	...
	varMessageAttemptOut := _MessageAttemptOut{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMessageAttemptOut)

	if err != nil {
		return err
	}

	*o = MessageAttemptOut(varMessageAttemptOut)
