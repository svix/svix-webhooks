...
func NewReplayOut(id string, status BackgroundTaskStatus) *ReplayOut {
	this := ReplayOut{}
	this.Id = id
	this.Status = status
	var task string = "endpoint.replay"
	this.Task = &task
	return &this
}
...
func (o *ReplayOut) GetTask() string {
	if o == nil || o.Task == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ReplayOut) GetTaskOk() (*string, bool) {
	if o == nil || o.Task == nil {
		return nil, false
	}
	return o.Task, true
...
func (o *ReplayOut) SetTask(v string) {
	o.Task = &v
}
