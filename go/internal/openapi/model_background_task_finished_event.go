...
// BackgroundTaskFinishedEvent Sent when a background task finishes.
type BackgroundTaskFinishedEvent struct {
	Data BackgroundTaskFinishedEventData `json:"data"`
...
func NewBackgroundTaskFinishedEvent(data BackgroundTaskFinishedEventData) *BackgroundTaskFinishedEvent {
...
func (o *BackgroundTaskFinishedEvent) GetData() BackgroundTaskFinishedEventData {
	if o == nil {
		var ret BackgroundTaskFinishedEventData
		return ret
	}
...
func (o *BackgroundTaskFinishedEvent) GetDataOk() (*BackgroundTaskFinishedEventData, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Data, true
...
func (o *BackgroundTaskFinishedEvent) SetData(v BackgroundTaskFinishedEventData) {
	o.Data = v
}
...
func (o *BackgroundTaskFinishedEvent) HasType() bool {
	if o != nil && o.Type != nil {
		return true
	}
