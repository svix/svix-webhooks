...
// checks if the EndpointUpdatedEventData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EndpointUpdatedEventData{}
...
type _EndpointUpdatedEventData EndpointUpdatedEventData
...
func (o *EndpointUpdatedEventData) UnmarshalJSON(data []byte) (err error) {
	...
	varEndpointUpdatedEventData := _EndpointUpdatedEventData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEndpointUpdatedEventData)

	if err != nil {
		return err
	}

	*o = EndpointUpdatedEventData(varEndpointUpdatedEventData)
