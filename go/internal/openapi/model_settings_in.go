...
// checks if the SettingsIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SettingsIn{}
...
func (o *SettingsIn) GetWipeSuccessfulPayload() bool {
...
// and a boolean to check if the value has been set.
func (o *SettingsIn) GetWipeSuccessfulPayloadOk() (*bool, bool) {
	if o == nil || IsNil(o.WipeSuccessfulPayload) {
		return nil, false
	}
...
func (o *SettingsIn) HasWipeSuccessfulPayload() bool {
	if o != nil && !IsNil(o.WipeSuccessfulPayload) {
		return true
	}
...
func (o *SettingsIn) SetWipeSuccessfulPayload(v bool) {
...
func (o SettingsIn) ToMap() (map[string]interface{}, error) {
