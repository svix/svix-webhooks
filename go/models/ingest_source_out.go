...
const (
	...
	IngestSourceOutTypeMerge          IngestSourceOutType = "merge"
...
func (MergeConfigOut) isIngestSourceOutConfig()     {}
...
var IngestSourceOutTypeFromString = map[string]IngestSourceOutType{
	...
	"merge":           IngestSourceOutTypeMerge,
