...
const (
	...
	IngestSourceInTypeMerge          IngestSourceInType = "merge"
...
func (MergeConfig) isIngestSourceInConfig()     {}
...
var IngestSourceInTypeFromString = map[string]IngestSourceInType{
	...
	"easypost":        IngestSourceInTypeEasypost,
