...
from .autoconfig import Autoconfig, AutoconfigAsync
...
class SvixAsync(ClientBase):
    ...
    @property
    def autoconfig(self) -> AutoconfigAsync:
        return AutoconfigAsync(self._client, self._httpx_client)
...
class Svix(ClientBase):
    ...
    @property
    def autoconfig(self) -> Autoconfig:
        return Autoconfig(self._client, self._httpx_client)
