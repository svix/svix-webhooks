...
@dataclass
class StreamStreamListOptions(BaseOptions):
...
@dataclass
class StreamStreamCreateOptions(BaseOptions):
...
class StreamStreamAsync(ApiBase):
    async def list(
        self, options: StreamStreamListOptions = StreamStreamListOptions()
