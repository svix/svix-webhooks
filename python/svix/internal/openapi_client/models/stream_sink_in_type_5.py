...
from ..models.stream_sink_in_type_5_type import StreamSinkInType5Type

if TYPE_CHECKING:
    from ..models.google_cloud_storage_config import GoogleCloudStorageConfig


T = TypeVar("T", bound="StreamSinkInType5")


@attr.s(auto_attribs=True)
class StreamSinkInType5:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = StreamSinkInType5Type(d.pop("type"))

        stream_sink_in_type_5 = cls(
            config=config,
            type=type,
        )

        stream_sink_in_type_5.additional_properties = d
        return stream_sink_in_type_5
