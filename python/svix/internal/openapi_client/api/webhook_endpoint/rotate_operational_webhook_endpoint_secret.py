...
from ...models.operational_webhook_endpoint_secret_in import OperationalWebhookEndpointSecretIn
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: OperationalWebhookEndpointSecretIn,
    idempotency_key: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v1/operational-webhook/endpoint/{endpoint_id}/secret/rotate".format(
        client.base_url, endpoint_id=endpoint_id
    )
