...
from ...models.list_response_operational_webhook_endpoint_out import ListResponseOperationalWebhookEndpointOut
...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/operational-webhook/endpoint".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> ListResponseOperationalWebhookEndpointOut:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListResponseOperationalWebhookEndpointOut.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ListResponseOperationalWebhookEndpointOut]:
    return Response(
...
def request_sync_detailed(
    *,
    ...
    iterator: Union[Unset, None, str] = UNSET,
    order: Union[Unset, None, Ordering] = UNSET,
) -> Response[ListResponseOperationalWebhookEndpointOut]:
