...
from ...models.operational_webhook_endpoint_in import OperationalWebhookEndpointIn
...
def _get_kwargs(
    *,
    ...
    json_body: OperationalWebhookEndpointIn,
...
def _parse_response(*, client: Client, response: httpx.Response) -> OperationalWebhookEndpointOut:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = OperationalWebhookEndpointOut.from_dict(response.json())
