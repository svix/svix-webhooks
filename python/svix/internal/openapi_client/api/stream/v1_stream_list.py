...
from ...models.list_response_stream_out import ListResponseStreamOut
...
def _parse_response(*, client: Client, response: httpx.Response) -> ListResponseStreamOut:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListResponseStreamOut.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ListResponseStreamOut]:
    return Response(
...
def request_sync_detailed(
    *,
    ...
    iterator: Union[Unset, None, str] = UNSET,
    order: Union[Unset, None, Ordering] = UNSET,
) -> Response[ListResponseStreamOut]:
    """List Streams
