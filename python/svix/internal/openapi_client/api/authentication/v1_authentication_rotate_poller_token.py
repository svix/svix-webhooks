...
from ...models.rotate_poller_token_in import RotatePollerTokenIn
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: RotatePollerTokenIn,
    idempotency_key: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v1/auth/app/{app_id}/poller/{endpoint_id}/token/rotate".format(
...
def _parse_response(*, client: Client, response: httpx.Response) -> AuthTokenOut:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = AuthTokenOut.from_dict(response.json())
