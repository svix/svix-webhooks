...
from ...models.list_response_sink_out import ListResponseSinkOut
...
def _parse_response(*, client: Client, response: httpx.Response) -> ListResponseSinkOut:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListResponseSinkOut.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ListResponseSinkOut]:
    return Response(
