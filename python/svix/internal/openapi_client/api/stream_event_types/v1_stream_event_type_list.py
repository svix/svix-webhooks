...
from ...models.list_response_stream_event_type_out import ListResponseStreamEventTypeOut
...
def _parse_response(*, client: Client, response: httpx.Response) -> ListResponseStreamEventTypeOut:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListResponseStreamEventTypeOut.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ListResponseStreamEventTypeOut]:
    return Response(
...
def request_sync_detailed(
    *,
    ...
    iterator: Union[Unset, None, str] = UNSET,
    order: Union[Unset, None, Ordering] = UNSET,
) -> Response[ListResponseStreamEventTypeOut]:
