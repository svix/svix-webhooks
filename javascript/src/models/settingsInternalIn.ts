...
export interface SettingsInternalIn {
...
export const SettingsInternalInSerializer = {
  _fromJsonObject(object: any): SettingsInternalIn {
    return {
  ...
  _toJsonObject(self: SettingsInternalIn): any {
    return {
