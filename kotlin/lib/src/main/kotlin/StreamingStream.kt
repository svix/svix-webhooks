...
data class StreamingStreamListOptions(
...
data class StreamingStreamCreateOptions(val idempotencyKey: String? = null)

class StreamingStream(private val client: SvixHttpClient) {
    /** List of all the organization's streams. */
    suspend fun list(
        options: StreamingStreamListOptions = StreamingStreamListOptions()
