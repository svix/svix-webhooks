...
data class StreamEventTypeListOptions(
...
data class StreamEventTypeCreateOptions(val idempotencyKey: String? = null)

data class StreamEventTypeDeleteOptions(
    /**
...
class StreamEventType(private val client: SvixHttpClient) {
    /** List of all the organization's event types for streaming. */
    suspend fun list(
        options: StreamEventTypeListOptions = StreamEventTypeListOptions()
