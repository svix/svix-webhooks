...
namespace Svix.Api
{
    public class AutoconfigCreateOptions : SvixOptionsBase
    {
    ...
    public class AutoconfigRotateOptions : SvixOptionsBase
    {
        public string? IdempotencyKey { get; set; }
    ...
    public class Autoconfig(SvixClient client)
    {
        ...
        public async Task<AutoConfigOut> CreateAsync(
            string appId,
            AutoconfigCreateOptions? options = null,
            CancellationToken cancellationToken = default
        )
        {
            if (options == null)
            {
                options = new AutoconfigCreateOptions();
            }
            try
            {
        ...
        /// Create an AutoConfig subscription.
        /// </summary>
        public AutoConfigOut Create(string appId, AutoconfigCreateOptions? options = null)
        {
            if (options == null)
            {
                options = new AutoconfigCreateOptions();
        ...
        public async Task<AutoConfigOut> RotateAsync(
            ...
            AutoconfigRotateOptions? options = null,
            CancellationToken cancellationToken = default
        )
        {
            if (options == null)
            {
                options = new AutoconfigRotateOptions();
            }
