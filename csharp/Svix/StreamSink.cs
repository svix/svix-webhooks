...
namespace Svix
{
    public class StreamSinkListOptions : SvixOptionsBase
    {
    ...
    public class StreamSinkCreateOptions : SvixOptionsBase
    {
    ...
    public class StreamSinkRotateSecretOptions : SvixOptionsBase
    {
        public string? IdempotencyKey { get; set; }
    ...
    public class StreamSink(SvixClient client)
    {
        ...
        public async Task<ListResponseStreamSinkOut> ListAsync(
            string streamId,
            StreamSinkListOptions? options = null,
        ...
        public async Task<StreamSinkOut> CreateAsync(
            ...
            StreamSinkCreateOptions? options = null,
            CancellationToken cancellationToken = default
        )
        {
        ...
        public async Task<EmptyResponse> RotateSecretAsync(
            ...
            StreamSinkRotateSecretOptions? options = null,
            CancellationToken cancellationToken = default
        )
        {
