...
namespace Svix.Model
{
    ...
    /// StreamSinkIn
    /// </summary>
    [JsonConverter(typeof(StreamSinkInJsonConverter))]
    [DataContract(Name = "StreamSinkIn")]
    public partial class StreamSinkIn : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamSinkIn" /> class
        /// with the <see cref="StreamSinkInOneOf" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of StreamSinkInOneOf.</param>
        public StreamSinkIn(StreamSinkInOneOf actualInstance)
        {
        ...
        public StreamSinkIn(StreamSinkInOneOf1 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkIn(StreamSinkInOneOf2 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkIn(StreamSinkInOneOf3 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkIn(StreamSinkInOneOf4 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkIn(StreamSinkInOneOf5 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkIn(StreamSinkInOneOf6 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkIn(StreamSinkInOneOf7 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, StreamSinkIn.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of StreamSinkIn
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of StreamSinkIn</returns>
        public static StreamSinkIn FromJson(string jsonString)
        {
            StreamSinkIn newStreamSinkIn = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newStreamSinkIn;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf>(jsonString, StreamSinkIn.SerializerSettings));
                }
                else
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf>(jsonString, StreamSinkIn.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf1>(jsonString, StreamSinkIn.SerializerSettings));
                }
                else
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf1>(jsonString, StreamSinkIn.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf2>(jsonString, StreamSinkIn.SerializerSettings));
                }
                else
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf2>(jsonString, StreamSinkIn.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf3>(jsonString, StreamSinkIn.SerializerSettings));
                }
                else
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf3>(jsonString, StreamSinkIn.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf4>(jsonString, StreamSinkIn.SerializerSettings));
                }
                else
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf4>(jsonString, StreamSinkIn.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf5>(jsonString, StreamSinkIn.SerializerSettings));
                }
                else
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf5>(jsonString, StreamSinkIn.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf6>(jsonString, StreamSinkIn.SerializerSettings));
                }
                else
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf6>(jsonString, StreamSinkIn.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf7>(jsonString, StreamSinkIn.SerializerSettings));
                }
                else
                {
                    newStreamSinkIn = new StreamSinkIn(JsonConvert.DeserializeObject<StreamSinkInOneOf7>(jsonString, StreamSinkIn.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for StreamSinkIn
    /// </summary>
    public class StreamSinkInJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(StreamSinkIn).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return StreamSinkIn.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return StreamSinkIn.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
