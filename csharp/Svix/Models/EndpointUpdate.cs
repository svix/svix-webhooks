...
namespace Svix.Model
{
    ...
    public partial class EndpointUpdate : IValidatableObject
    {
        /// <summary>
        ...
        public EndpointUpdate(List<string> channels = default(List<string>), string description = @"", bool disabled = false, List<string> filterTypes = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), int? rateLimit = default(int?), string uid = default(string), string url = default(string), int? varVersion = 1)
        {
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for EndpointUpdate and cannot be null");
            }
            this.Url = url;
