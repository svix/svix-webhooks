...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EndpointUpdatedEventData")]
    public partial class EndpointUpdatedEventData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointUpdatedEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EndpointUpdatedEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointUpdatedEventData" /> class.
        /// </summary>
        ...
        public EndpointUpdatedEventData(string appId = default(string), string appUid = default(string), string endpointId = default(string), string endpointUid = default(string))
        {
            // to ensure "appId" is required (not null)
            if (appId == null)
            {
                throw new ArgumentNullException("appId is a required property for EndpointUpdatedEventData and cannot be null");
            }
            this.AppId = appId;
            // to ensure "endpointId" is required (not null)
            if (endpointId == null)
            {
                throw new ArgumentNullException("endpointId is a required property for EndpointUpdatedEventData and cannot be null");
            }
