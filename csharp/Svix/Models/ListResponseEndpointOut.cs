...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListResponse_EndpointOut_")]
    public partial class ListResponseEndpointOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListResponseEndpointOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListResponseEndpointOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListResponseEndpointOut" /> class.
        /// </summary>
        ...
        public ListResponseEndpointOut(List<EndpointOut> data = default(List<EndpointOut>), bool done = default(bool), string iterator = default(string), string prevIterator = default(string))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListResponseEndpointOut and cannot be null");
            }
            this.Data = data;
            this.Done = done;
            ...
            if (iterator == null)
            {
                throw new ArgumentNullException("iterator is a required property for ListResponseEndpointOut and cannot be null");
            }
