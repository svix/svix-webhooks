...
namespace Svix.Model
{
    ...
    /// EndpointSecretOut
    /// </summary>
    [DataContract(Name = "EndpointSecretOut")]
    public partial class EndpointSecretOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointSecretOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EndpointSecretOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointSecretOut" /> class.
        /// </summary>
        ...
        public EndpointSecretOut(string key = default(string))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for EndpointSecretOut and cannot be null");
            }
            this.Key = key;
        }
