...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessageAttemptEndpointOut")]
    public partial class MessageAttemptEndpointOut : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageAttemptEndpointOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageAttemptEndpointOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageAttemptEndpointOut" /> class.
        /// </summary>
        ...
        public MessageAttemptEndpointOut(string endpointId = default(string), string id = default(string), MessageOut msg = default(MessageOut), string msgId = default(string), string response = default(string), long responseDurationMs = default(long), int responseStatusCode = default(int), MessageStatus status = default(MessageStatus), DateTime timestamp = default(DateTime), MessageAttemptTriggerType triggerType = default(MessageAttemptTriggerType), string url = default(string))
        {
            // to ensure "endpointId" is required (not null)
            if (endpointId == null)
            {
                throw new ArgumentNullException("endpointId is a required property for MessageAttemptEndpointOut and cannot be null");
            }
            this.EndpointId = endpointId;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for MessageAttemptEndpointOut and cannot be null");
            }
            this.Id = id;
            // to ensure "msgId" is required (not null)
            if (msgId == null)
            {
                throw new ArgumentNullException("msgId is a required property for MessageAttemptEndpointOut and cannot be null");
            }
            this.MsgId = msgId;
            // to ensure "response" is required (not null)
            if (response == null)
            {
                throw new ArgumentNullException("response is a required property for MessageAttemptEndpointOut and cannot be null");
            }
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MessageAttemptEndpointOut and cannot be null");
            }
            this.Url = url;
            this.Msg = msg;
        }
