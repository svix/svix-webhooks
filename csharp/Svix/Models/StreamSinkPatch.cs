...
namespace Svix.Model
{
    ...
    /// StreamSinkPatch
    /// </summary>
    [JsonConverter(typeof(StreamSinkPatchJsonConverter))]
    [DataContract(Name = "StreamSinkPatch")]
    public partial class StreamSinkPatch : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamSinkPatch" /> class
        /// with the <see cref="StreamSinkInOneOf" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of StreamSinkInOneOf.</param>
        public StreamSinkPatch(StreamSinkInOneOf actualInstance)
        {
        ...
        public StreamSinkPatch(StreamSinkInOneOf1 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkPatch(StreamSinkInOneOf2 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkPatch(StreamSinkInOneOf3 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkPatch(StreamSinkInOneOf4 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkPatch(StreamSinkInOneOf5 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkPatch(StreamSinkInOneOf6 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public StreamSinkPatch(StreamSinkInOneOf7 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, StreamSinkPatch.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of StreamSinkPatch
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of StreamSinkPatch</returns>
        public static StreamSinkPatch FromJson(string jsonString)
        {
            StreamSinkPatch newStreamSinkPatch = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newStreamSinkPatch;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf>(jsonString, StreamSinkPatch.SerializerSettings));
                }
                else
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf>(jsonString, StreamSinkPatch.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf1>(jsonString, StreamSinkPatch.SerializerSettings));
                }
                else
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf1>(jsonString, StreamSinkPatch.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf2>(jsonString, StreamSinkPatch.SerializerSettings));
                }
                else
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf2>(jsonString, StreamSinkPatch.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf3>(jsonString, StreamSinkPatch.SerializerSettings));
                }
                else
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf3>(jsonString, StreamSinkPatch.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf4>(jsonString, StreamSinkPatch.SerializerSettings));
                }
                else
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf4>(jsonString, StreamSinkPatch.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf5>(jsonString, StreamSinkPatch.SerializerSettings));
                }
                else
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf5>(jsonString, StreamSinkPatch.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf6>(jsonString, StreamSinkPatch.SerializerSettings));
                }
                else
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf6>(jsonString, StreamSinkPatch.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf7>(jsonString, StreamSinkPatch.SerializerSettings));
                }
                else
                {
                    newStreamSinkPatch = new StreamSinkPatch(JsonConvert.DeserializeObject<StreamSinkInOneOf7>(jsonString, StreamSinkPatch.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for StreamSinkPatch
    /// </summary>
    public class StreamSinkPatchJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(StreamSinkPatch).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return StreamSinkPatch.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return StreamSinkPatch.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
