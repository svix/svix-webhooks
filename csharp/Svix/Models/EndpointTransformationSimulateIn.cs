...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EndpointTransformationSimulateIn")]
    public partial class EndpointTransformationSimulateIn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointTransformationSimulateIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EndpointTransformationSimulateIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointTransformationSimulateIn" /> class.
        /// </summary>
        ...
        public EndpointTransformationSimulateIn(List<string> channels = default(List<string>), string code = default(string), string eventType = default(string), Object payload = default(Object))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for EndpointTransformationSimulateIn and cannot be null");
            }
            this.Code = code;
            // to ensure "eventType" is required (not null)
            if (eventType == null)
            {
                throw new ArgumentNullException("eventType is a required property for EndpointTransformationSimulateIn and cannot be null");
            }
            this.EventType = eventType;
            // to ensure "payload" is required (not null)
            if (payload == null)
            {
                throw new ArgumentNullException("payload is a required property for EndpointTransformationSimulateIn and cannot be null");
            }
