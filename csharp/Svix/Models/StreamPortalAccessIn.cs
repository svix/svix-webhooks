...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StreamPortalAccessIn")]
    public partial class StreamPortalAccessIn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamPortalAccessIn" /> class.
        /// </summary>
        ...
        public StreamPortalAccessIn(int? expiry = 604800, List<string> featureFlags = default(List<string>), bool? readOnly = default(bool?))
        {
