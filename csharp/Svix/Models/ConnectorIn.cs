...
namespace Svix.Model
{
    ...
    /// ConnectorIn
    /// </summary>
    [DataContract(Name = "ConnectorIn")]
    public partial class ConnectorIn : IValidatableObject
    {
        ...
        public ConnectorIn(string description = @"", string featureFlag = default(string), List<string> filterTypes = default(List<string>), string instructions = @"", string instructionsLink = default(string), ConnectorKind? kind = default(ConnectorKind?), string logo = default(string), string name = default(string), string transformation = default(string))
        {
            // to ensure "logo" is required (not null)
            if (logo == null)
            {
                throw new ArgumentNullException("logo is a required property for ConnectorIn and cannot be null");
            }
            this.Logo = logo;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ConnectorIn and cannot be null");
            }
            this.Name = name;
            // to ensure "transformation" is required (not null)
            if (transformation == null)
            {
                throw new ArgumentNullException("transformation is a required property for ConnectorIn and cannot be null");
            }
