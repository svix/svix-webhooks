...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EndpointCreatedEventData")]
    public partial class EndpointCreatedEventData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointCreatedEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EndpointCreatedEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointCreatedEventData" /> class.
        /// </summary>
        ...
        public EndpointCreatedEventData(string appId = default(string), string appUid = default(string), string endpointId = default(string), string endpointUid = default(string))
        {
            // to ensure "appId" is required (not null)
            if (appId == null)
            {
                throw new ArgumentNullException("appId is a required property for EndpointCreatedEventData and cannot be null");
            }
            this.AppId = appId;
            // to ensure "endpointId" is required (not null)
            if (endpointId == null)
            {
                throw new ArgumentNullException("endpointId is a required property for EndpointCreatedEventData and cannot be null");
            }
