...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OperationalWebhookEndpointSecretOut")]
    public partial class OperationalWebhookEndpointSecretOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationalWebhookEndpointSecretOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OperationalWebhookEndpointSecretOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationalWebhookEndpointSecretOut" /> class.
        /// </summary>
        /// <param name="key">The endpoint&#39;s verification secret.  Format: &#x60;base64&#x60; encoded random bytes optionally prefixed with &#x60;whsec_&#x60;. It is recommended to not set this and let the server generate the secret. (required).</param>
        public OperationalWebhookEndpointSecretOut(string key = default(string))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for OperationalWebhookEndpointSecretOut and cannot be null");
            }
            this.Key = key;
        }
