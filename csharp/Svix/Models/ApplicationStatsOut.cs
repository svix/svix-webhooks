...
{
    /// <summary>
    /// A copy of  [&#x60;backgroundtask::ApplicationStats&#x60;], but serialized with camelCase fields for customers.
    /// </summary>
    [DataContract(Name = "ApplicationStatsOut")]
    public partial class ApplicationStatsOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationStatsOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApplicationStatsOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationStatsOut" /> class.
        /// </summary>
        ...
        public ApplicationStatsOut(string appId = default(string), string appUid = default(string), long messageDestinations = default(long))
        {
            // to ensure "appId" is required (not null)
            if (appId == null)
            {
                throw new ArgumentNullException("appId is a required property for ApplicationStatsOut and cannot be null");
            }
            this.AppId = appId;
        ...
        */
        ...
        public long MessageDestinations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationStatsOut {\n");
