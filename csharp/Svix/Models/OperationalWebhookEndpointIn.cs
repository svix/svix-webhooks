...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OperationalWebhookEndpointIn")]
    public partial class OperationalWebhookEndpointIn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationalWebhookEndpointIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OperationalWebhookEndpointIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationalWebhookEndpointIn" /> class.
        /// </summary>
        ...
        public OperationalWebhookEndpointIn(string description = @"", bool disabled = false, List<string> filterTypes = default(List<string>), Dictionary<string, string> metadata = default(Dictionary<string, string>), int? rateLimit = default(int?), string secret = default(string), string uid = default(string), string url = default(string))
        {
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for OperationalWebhookEndpointIn and cannot be null");
            }
            this.Url = url;
