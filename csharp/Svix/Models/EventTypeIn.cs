...
namespace Svix.Model
{
    ...
    /// EventTypeIn
    /// </summary>
    [DataContract(Name = "EventTypeIn")]
    public partial class EventTypeIn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventTypeIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EventTypeIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EventTypeIn" /> class.
        /// </summary>
        ...
        public EventTypeIn(bool archived = false, bool deprecated = false, string description = default(string), string featureFlag = default(string), string groupName = default(string), string name = default(string), Object schemas = default(Object))
        {
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for EventTypeIn and cannot be null");
            }
            this.Description = description;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for EventTypeIn and cannot be null");
            }
            this.Name = name;
