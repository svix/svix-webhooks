...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EndpointTransformationOut")]
    public partial class EndpointTransformationOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointTransformationOut" /> class.
        /// </summary>
        /// <param name="code">code.</param>
        /// <param name="enabled">enabled (default to false).</param>
        public EndpointTransformationOut(string code = default(string), bool enabled = false)
        {
            this.Code = code;
