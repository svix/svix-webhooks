...
namespace Svix.Model
{
    ...
    /// MessageEndpointOut
    /// </summary>
    [DataContract(Name = "MessageEndpointOut")]
    public partial class MessageEndpointOut : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageEndpointOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageEndpointOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageEndpointOut" /> class.
        /// </summary>
        ...
        public MessageEndpointOut(List<string> channels = default(List<string>), DateTime createdAt = default(DateTime), string description = default(string), bool disabled = false, List<string> filterTypes = default(List<string>), string id = default(string), DateTime? nextAttempt = default(DateTime?), int? rateLimit = default(int?), MessageStatus status = default(MessageStatus), string uid = default(string), DateTime updatedAt = default(DateTime), string url = default(string), int varVersion = default(int))
        {
            this.CreatedAt = createdAt;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for MessageEndpointOut and cannot be null");
            }
            this.Description = description;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for MessageEndpointOut and cannot be null");
            }
            this.Id = id;
            this.Status = status;
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MessageEndpointOut and cannot be null");
            }
            this.Url = url;
