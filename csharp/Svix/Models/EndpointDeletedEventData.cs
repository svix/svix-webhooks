...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EndpointDeletedEventData")]
    public partial class EndpointDeletedEventData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointDeletedEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EndpointDeletedEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointDeletedEventData" /> class.
        /// </summary>
        ...
        public EndpointDeletedEventData(string appId = default(string), string appUid = default(string), string endpointId = default(string), string endpointUid = default(string))
        {
            // to ensure "appId" is required (not null)
            if (appId == null)
            {
                throw new ArgumentNullException("appId is a required property for EndpointDeletedEventData and cannot be null");
            }
            this.AppId = appId;
            // to ensure "endpointId" is required (not null)
            if (endpointId == null)
            {
                throw new ArgumentNullException("endpointId is a required property for EndpointDeletedEventData and cannot be null");
            }
