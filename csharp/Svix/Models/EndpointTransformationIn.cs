...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EndpointTransformationIn")]
    public partial class EndpointTransformationIn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointTransformationIn" /> class.
        /// </summary>
        /// <param name="code">code.</param>
        /// <param name="enabled">enabled.</param>
        public EndpointTransformationIn(string code = default(string), bool enabled = default(bool))
        {
            this.Code = code;
