...
namespace Svix.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EndpointDisabledEventData")]
    public partial class EndpointDisabledEventData : IValidatableObject
    {
        ...
        public EndpointDisabledTrigger? Trigger { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointDisabledEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EndpointDisabledEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointDisabledEventData" /> class.
        /// </summary>
        ...
        /// <param name="failSince">failSince.</param>
        /// <param name="trigger">trigger.</param>
        public EndpointDisabledEventData(string appId = default(string), string appUid = default(string), string endpointId = default(string), string endpointUid = default(string), DateTime? failSince = default(DateTime?), EndpointDisabledTrigger? trigger = default(EndpointDisabledTrigger?))
        {
            // to ensure "appId" is required (not null)
            if (appId == null)
            {
                throw new ArgumentNullException("appId is a required property for EndpointDisabledEventData and cannot be null");
            }
            this.AppId = appId;
            // to ensure "endpointId" is required (not null)
            if (endpointId == null)
            {
                throw new ArgumentNullException("endpointId is a required property for EndpointDisabledEventData and cannot be null");
            }
        ...
        */
        ...
        /// <summary>
        /// Gets or Sets FailSince
        /// </summary>
        [DataMember(Name = "failSince", EmitDefaultValue = true)]
        public DateTime? FailSince { get; set; }
