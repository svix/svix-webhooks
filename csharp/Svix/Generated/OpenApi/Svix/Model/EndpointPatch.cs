...
namespace Svix.Model
{
    ...
    public partial class EndpointPatch : IValidatableObject
    {
        ...
        public EndpointPatch(
            ...
            List<string> filterTypes = default(List<string>),
            Dictionary<string, string> metadata = default(Dictionary<string, string>),
            int? rateLimit = default(int?),
        ...
        )
        {
            ...
            if (this.RateLimit < (int?)0)
            {
                yield return new ValidationResult(
                    "Invalid value for RateLimit, must be a value greater than or equal to 0.",
                    new[] { "RateLimit" }
                );
            }
            ...
            if (this.Secret != null)
            {
                ...
                if (!regexSecret.Match(this.Secret).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult(
                        "Invalid value for Secret, must match a pattern of " + regexSecret,
                        new[] { "Secret" }
                    );
                }
            }
            ...
            {
                yield return new ValidationResult(
                    "Invalid value for Uid, length must be less than 256.",
                    new[] { "Uid" }
                );
            }
            ...
            {
                yield return new ValidationResult(
                    "Invalid value for Uid, length must be greater than 1.",
                    new[] { "Uid" }
                );
            }
            ...
            if (this.Uid != null)
            {
                ...
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult(
                        "Invalid value for Uid, must match a pattern of " + regexUid,
                        new[] { "Uid" }
                    );
                }
            }
            ...
            {
                yield return new ValidationResult(
                    "Invalid value for Version, must be a value greater than or equal to 1.",
                    new[] { "Version" }
                );
            }
