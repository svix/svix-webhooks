...
namespace Svix.Model
{
    ...
    public partial class EventTypePatch : IValidatableObject
    {
        ...
        public EventTypePatch(
            bool archived = default(bool),
            bool deprecated = default(bool),
            string description = default(string),
            string featureFlag = default(string),
            string groupName = default(string),
            Dictionary<string, Object> schemas = default(Dictionary<string, Object>)
        )
        {
        ...
        )
        {
            ...
            if (this.FeatureFlag != null && this.FeatureFlag.Length > 256)
            {
                yield return new ValidationResult(
                    "Invalid value for FeatureFlag, length must be less than 256.",
                    new[] { "FeatureFlag" }
                );
            }
            ...
            if (this.FeatureFlag != null)
            {
                ...
                Regex regexFeatureFlag = new Regex(
                    @"^[a-zA-Z0-9\-_.]+$",
                ...
                if (!regexFeatureFlag.Match(this.FeatureFlag).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult(
                        "Invalid value for FeatureFlag, must match a pattern of "
                            + regexFeatureFlag,
                        new[] { "FeatureFlag" }
                    );
                }
            ...
            {
                yield return new ValidationResult(
                    "Invalid value for GroupName, length must be less than 256.",
                    new[] { "GroupName" }
                );
            }
            ...
            if (this.GroupName != null)
            {
                ...
                Regex regexGroupName = new Regex(
                    @"^[a-zA-Z0-9\-_.]+$",
                    RegexOptions.CultureInvariant
                );
                ...
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult(
                        "Invalid value for GroupName, must match a pattern of " + regexGroupName,
                        new[] { "GroupName" }
                    );
                }
            }
