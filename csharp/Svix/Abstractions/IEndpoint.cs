...
namespace Svix.Abstractions
{
    public interface IEndpoint
    {
        ...
        EndpointHeadersOut GetHeaders(
            string appId,
            string endpointId,
            string idempotencyKey = default
        );

        Task<EndpointHeadersOut> GetHeadersAsync(
            string appId,
            string endpointId,
            string idempotencyKey = default,
            CancellationToken cancellationToken = default
        ...
        ListResponseEndpointOut List(
            string appId,
            ListOptions options = null,
            string idempotencyKey = default
        );

        Task<ListResponseEndpointOut> ListAsync(
            string appId,
            ListOptions options = null,
            string idempotencyKey = default,
            CancellationToken cancellationToken = default
        ...
        Task<EndpointStats> GetStatsAsync(
            string appId,
            string endpointId,
            string idempotencyKey = default,
            CancellationToken cancellationToken = default
