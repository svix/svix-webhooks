...
namespace Svix.Abstractions
{
    public interface IEventType
    {
        ...
        Task<EventTypeOut> GetAsync(
            string eventType,
            string idempotencyKey = default,
            CancellationToken cancellationToken = default
        );

        ListResponseEventTypeOut List(
            EventTypeListOptions options = null,
            string idempotencyKey = default
        );

        Task<ListResponseEventTypeOut> ListAsync(
            EventTypeListOptions options = null,
            string idempotencyKey = default,
            CancellationToken cancellationToken = default
        );
