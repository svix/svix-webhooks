...
namespace Svix
{
    public class StreamStreamListOptions : SvixOptionsBase
    {
    ...
    public class StreamStreamCreateOptions : SvixOptionsBase
    {
    ...
    public class StreamStream(SvixClient client)
    {
        ...
        /// List of all the organization's streams.
        /// </summary>
        public ListResponseStreamOut List(StreamStreamListOptions? options = null)
        {
            try
            {
        ...
        /// Creates a new stream.
        /// </summary>
        public StreamOut Create(StreamIn streamIn, StreamStreamCreateOptions? options = null)
        {
            streamIn = streamIn ?? throw new ArgumentNullException(nameof(streamIn));
            try
            {
