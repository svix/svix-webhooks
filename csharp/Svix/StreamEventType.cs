...
namespace Svix
{
    public class StreamEventTypeListOptions : SvixOptionsBase
    {
    ...
    public class StreamEventTypeCreateOptions : SvixOptionsBase
    {
    ...
    public class StreamEventTypeDeleteOptions : SvixOptionsBase
    {
    ...
    public class StreamEventType(SvixClient client)
    {
        ...
        /// List of all the organization's event types for streaming.
        /// </summary>
        public ListResponseStreamEventTypeOut List(StreamEventTypeListOptions? options = null)
        {
            try
            {
        ...
        /// Delete an event type.
        /// </summary>
        public bool Delete(string name, StreamEventTypeDeleteOptions? options = null)
        {
            try
            {
