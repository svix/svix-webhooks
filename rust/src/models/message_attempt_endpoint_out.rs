...
use serde::{Deserialize, Serialize};
                ...
                pub struct MessageAttemptEndpointOut {
                    ...
                    pub fn new(endpoint_id: String, id: String, msg_id: String, response: String, response_duration_ms: i64, response_status_code: i32, status: models::MessageStatus, timestamp: String, trigger_type: models::MessageAttemptTriggerType, url: String) -> MessageAttemptEndpointOut {
