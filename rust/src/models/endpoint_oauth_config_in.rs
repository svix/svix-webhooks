...
pub struct EndpointOauthConfigIn {
    ...
    /// Optional client secret. This is only used for `clientSecretBasic` and
    /// `clientSecretPost`.  For `clientSecretBasic`, the secret will be
    /// appended to the `Authorization` header. For `clientSecretPost`, this
...
impl EndpointOauthConfigIn {
    pub fn new(
        auth_method: models::Oauth2AuthMethodIn,
        client_id: String,
        grant_type: models::Oauth2GrantTypeIn,
        token_url: String,
