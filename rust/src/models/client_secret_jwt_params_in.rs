...
pub struct ClientSecretJwtParamsIn {
    ...
    /// Optional secret identifier. If supplied, this will be populated in the
    /// JWT header in the `kid` field.
    #[serde(rename = "secretId", skip_serializing_if = "Option::is_none")]
    pub secret_id: Option<String>,
    #[serde(rename = "signingAlgorithm")]
    pub signing_algorithm: models::OauthJwsSigningAlgorithm,
    /// Optional number of seconds after which the JWT should expire. Defaults
    /// to 300 seconds.
...
impl ClientSecretJwtParamsIn {
    pub fn new(
        ...
        signing_algorithm: models::OauthJwsSigningAlgorithm,
