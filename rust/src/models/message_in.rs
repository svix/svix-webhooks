...
pub struct MessageIn {
    ...
    /// JSON payload to send as the request body of the webhook.  We also
    /// support sending non-JSON payloads. Please contact us for more
    /// information.
