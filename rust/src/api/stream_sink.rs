...
impl<'a> StreamSink<'a> {
    ...
    pub async fn list(
        &self,
        stream_id: String,
        options: Option<StreamSinkListOptions>,
    ...
    pub async fn create(
        ...
        options: Option<StreamSinkCreateOptions>,
    ) -> Result<StreamSinkOut> {
        let StreamSinkCreateOptions { idempotency_key } = options.unwrap_or_default();
    ...
    pub async fn rotate_secret(
        ...
        options: Option<StreamSinkRotateSecretOptions>,
    ) -> Result<EmptyResponse> {
        let StreamSinkRotateSecretOptions { idempotency_key } = options.unwrap_or_default();
