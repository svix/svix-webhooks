...
impl<'a> IngestEndpoint<'a> {
    ...
    pub async fn get(&self, endpoint_id: String) -> Result<IngestEndpointOut> {
        crate::request::Request::new(
            http1::Method::GET,
    ...
    pub async fn get_headers(&self, endpoint_id: String) -> Result<IngestEndpointHeadersOut> {
        crate::request::Request::new(
            http1::Method::GET,
    ...
    pub async fn get_secret(&self, endpoint_id: String) -> Result<IngestEndpointSecretOut> {
        crate::request::Request::new(
            http1::Method::GET,
