...
module Svix
    class MessageAttemptAPI
        ...
        def list_attempted_messages(app_id, endpoint_id, options = MessageAttemptListOptions.new)
            return @api.list_attempted_messages_api_v1_app_app_id_endpoint_endpoint_id_msg_get(endpoint_id, app_id, options)
        end

        def list_attempted_destinations(app_id, msg_id, options = MessageAttemptListOptions.new)
            return @api.list_attempted_destinations_api_v1_app_app_id_msg_msg_id_endpoint_get(msg_id, app_id, options)
        end

        def list_attempts_for_endpoint(app_id, endpoint_id, msg_id, options = MessageAttemptListOptions.new)
