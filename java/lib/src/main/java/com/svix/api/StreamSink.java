...
public class StreamSink {
    ...
    public StreamSink(SvixHttpClient client) {
        this.client = client;
    }
    ...
    public ListResponseStreamSinkOut list(final String streamId) throws IOException, ApiException {
        return this.list(streamId, new StreamSinkListOptions());
    }

    /** List of all the stream's sinks. */
    public ListResponseStreamSinkOut list(
            final String streamId, final StreamSinkListOptions options)
    ...
    public StreamSinkOut create(final String streamId, final StreamSinkIn streamSinkIn)
            throws IOException, ApiException {
        return this.create(streamId, streamSinkIn, new StreamSinkCreateOptions());
    }
    ...
    public StreamSinkOut create(
            ...
            final StreamSinkCreateOptions options)
            throws IOException, ApiException {
        HttpUrl.Builder url =
                this.client
                        .newUrlBuilder()
    ...
    public EmptyResponse rotateSecret(
        ...
        return this.rotateSecret(
                streamId, sinkId, endpointSecretRotateIn, new StreamSinkRotateSecretOptions());
    }
    ...
    public EmptyResponse rotateSecret(
            ...
            final String sinkId,
            final EndpointSecretRotateIn endpointSecretRotateIn,
            final StreamSinkRotateSecretOptions options)
            throws IOException, ApiException {
        HttpUrl.Builder url =
                this.client
                        .newUrlBuilder()
