...
public class StreamingEvents {
    ...
    public StreamingEvents(SvixHttpClient client) {
        this.client = client;
    }
    ...
    public EventStreamOut get(final String streamId, final String sinkId)
            throws IOException, ApiException {
        return this.get(streamId, sinkId, new StreamingEventsGetOptions());
    }
    ...
    public EventStreamOut get(
            final String streamId, final String sinkId, final StreamingEventsGetOptions options)
            throws IOException, ApiException {
        HttpUrl.Builder url =
                this.client
                        .newUrlBuilder()
