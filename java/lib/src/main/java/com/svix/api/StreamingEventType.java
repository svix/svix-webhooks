...
public class StreamingEventType {
    private final SvixHttpClient client;

    public StreamingEventType(SvixHttpClient client) {
        this.client = client;
    }
    ...
    public ListResponseStreamEventTypeOut list() throws IOException, ApiException {
        ...
        return this.list(new StreamingEventTypeListOptions());
    }

    /** List of all the organization's event types for streaming. */
    public ListResponseStreamEventTypeOut list(final StreamingEventTypeListOptions options)
    ...
    public StreamEventTypeOut create(final StreamEventTypeIn streamEventTypeIn)
            throws IOException, ApiException {
        return this.create(streamEventTypeIn, new StreamingEventTypeCreateOptions());
    }

    /** Create an event type for Streams. */
    public StreamEventTypeOut create(
            final StreamEventTypeIn streamEventTypeIn,
            final StreamingEventTypeCreateOptions options)
            throws IOException, ApiException {
        HttpUrl.Builder url = this.client.newUrlBuilder().encodedPath("/api/v1/stream/event-type");
    ...
    public void delete(final String name) throws IOException, ApiException {
        this.delete(name, new StreamingEventTypeDeleteOptions());
    }

    /** Delete an event type. */
    public void delete(final String name, final StreamingEventTypeDeleteOptions options)
            throws IOException, ApiException {
        HttpUrl.Builder url =
                this.client
                        .newUrlBuilder()
