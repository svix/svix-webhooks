...
public abstract class IngestSourceOutConfig {
    ...
    @EqualsAndHashCode(callSuper = false)
    @VariantName("merge")
    public static class Merge extends IngestSourceOutConfig {
        private final MergeConfigOut merge;
    ...
    public static class Tailscale extends IngestSourceOutConfig {
        private final TailscaleConfigOut tailscale;
    ...
    @EqualsAndHashCode(callSuper = false)
    @VariantName("vgs")
    public static class Vgs extends IngestSourceOutConfig {
        private final VgsConfigOut vgs;
    ...
    static {
        ...
        TY_M.put("merge", c -> new Merge(m.convertValue(c, MergeConfigOut.class)));
        ...
        TY_M.put("tailscale", c -> new Tailscale(m.convertValue(c, TailscaleConfigOut.class)));
        ...
        TY_M.put("vgs", c -> new Vgs(m.convertValue(c, VgsConfigOut.class)));
    }
