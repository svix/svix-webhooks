...
public class IntegrationOut {
    ...
    public IntegrationOut addFeatureFlagsItem(String featureFlagsItem) {
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to IntegrationOut
     */
    public static IntegrationOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, IntegrationOut.class);
    }
