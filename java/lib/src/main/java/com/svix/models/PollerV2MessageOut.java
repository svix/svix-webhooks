...
public class PollerV2MessageOut {
    ...
    public PollerV2MessageOut eventType(String eventType) {
    ...
    public PollerV2MessageOut addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    /**
     * Create an instance of PollerV2MessageOut given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PollerV2MessageOut
     * @throws JsonProcessingException if the JSON string is invalid with respect to
     *     PollerV2MessageOut
     */
    public static PollerV2MessageOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, PollerV2MessageOut.class);
    }

    /**
     * Convert an instance of PollerV2MessageOut to an JSON string
     *
     * @return JSON string
     */
