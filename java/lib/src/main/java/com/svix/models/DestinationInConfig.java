...
@ToString
@EqualsAndHashCode
public abstract class DestinationInConfig {
    @JsonIgnore
    ...
    public static class PollingEndpoint extends DestinationInConfig {
        @Override
    ...
    public static class AzureBlobStorage extends DestinationInConfig {
    ...
    public static class OtelTracing extends DestinationInConfig {
    ...
    public static class FifoEndpoint extends DestinationInConfig {
        private final FifoEndpointConfigIn fifoEndpoint;
    ...
    public static class AmazonS3 extends DestinationInConfig {
    ...
    public static class GoogleCloudStorage extends DestinationInConfig {
    ...
    public static class GoogleCloudPubSub extends DestinationInConfig {
    ...
    @EqualsAndHashCode(callSuper = false)
    @VariantName("sqs")
    public static class Sqs extends DestinationInConfig {
    ...
    @EqualsAndHashCode(callSuper = false)
    @VariantName("sns")
    public static class Sns extends DestinationInConfig {
    ...
    public static class BigQuery extends DestinationInConfig {
    ...
    public static class Clickhouse extends DestinationInConfig {
    ...
    public static class EventBridge extends DestinationInConfig {
    ...
    public static class Snowflake extends DestinationInConfig {
    ...
    public static class RabbitMq extends DestinationInConfig {
    ...
    public static class Redshift extends DestinationInConfig {
    ...
    public static class Postgres extends DestinationInConfig {
        private final PostgresConfigIn postgres;
    ...
    private interface TypeFactory {
        DestinationInConfig create(JsonNode config);
    }
    ...
    static {
        ...
        TY_M.put(
                "fifoEndpoint",
                c -> new FifoEndpoint(m.convertValue(c, FifoEndpointConfigIn.class)));
    ...
    public static DestinationInConfig fromTypeAndConfig(String type, JsonNode config) {
