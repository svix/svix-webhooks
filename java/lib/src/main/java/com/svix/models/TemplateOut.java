...
public class TemplateOut {
    ...
    public TemplateOut kind(ConnectorKind kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to TemplateOut
     */
    public static TemplateOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, TemplateOut.class);
    }
