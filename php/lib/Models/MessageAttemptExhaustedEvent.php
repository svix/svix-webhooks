...
class MessageAttemptExhaustedEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Svix\Svix\Models\MessageAttemptExhaustedEventData',
        'type' => 'string'
    ];
    ...
    const TYPE_MESSAGE_ATTEMPT_EXHAUSTED = 'message.attempt.exhausted';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = $data['type'] ?? TYPE_MESSAGE_ATTEMPT_EXHAUSTED;
    }
     ...
     * Gets data
     *
     * @return \Svix\Svix\Models\MessageAttemptExhaustedEventData
     */
     ...
     * Sets data
     *
     * @param \Svix\Svix\Models\MessageAttemptExhaustedEventData $data data
     *
     * @return self
     */
