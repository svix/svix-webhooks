...
class EndpointCreatedEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Svix\Svix\Models\EndpointCreatedEventData',
        'type' => 'string'
    ];
    ...
    const TYPE_ENDPOINT_CREATED = 'endpoint.created';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = $data['type'] ?? TYPE_ENDPOINT_CREATED;
    }
     ...
     * Gets data
     *
     * @return \Svix\Svix\Models\EndpointCreatedEventData
     */
     ...
     * Sets data
     *
     * @param \Svix\Svix\Models\EndpointCreatedEventData $data data
     *
     * @return self
     */
