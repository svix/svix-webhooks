...
class ListResponseMessageAttemptEndpointOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Svix\Svix\Models\MessageAttemptEndpointOut[]',
        'done' => 'bool',
        'iterator' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Svix\Svix\Models\MessageAttemptEndpointOut[]
     */
     ...
     * Sets data
     *
     * @param \Svix\Svix\Models\MessageAttemptEndpointOut[] $data data
     *
     * @return self
     */
