...
class MessageAttemptFailingEventData implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \Svix\Utils::deserializeString($data, 'appId', true, 'MessageAttemptFailingEventData'),
            appUid: \Svix\Utils::deserializeString($data, 'appUid', false, 'MessageAttemptFailingEventData'),
            endpointId: \Svix\Utils::deserializeString($data, 'endpointId', true, 'MessageAttemptFailingEventData'),
            lastAttempt: \Svix\Utils::deserializeObject($data, 'lastAttempt', true, 'MessageAttemptFailingEventData', [MessageAttemptFailedData::class, 'fromMixed']),
            msgEventId: \Svix\Utils::deserializeString($data, 'msgEventId', false, 'MessageAttemptFailingEventData'),
            msgId: \Svix\Utils::deserializeString($data, 'msgId', true, 'MessageAttemptFailingEventData')
        );
    }
