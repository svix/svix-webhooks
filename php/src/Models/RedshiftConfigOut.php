...
class RedshiftConfigOut implements \JsonSerializable
{
    ...
    public static function fromMixed(mixed $data): self
    {
        return new self(
            ...
            workgroupName: \Svix\Utils::deserializeString($data, 'workgroupName', false, 'RedshiftConfigOut'),
            dbName: \Svix\Utils::deserializeString($data, 'dbName', false, 'RedshiftConfigOut'),
            schemaName: \Svix\Utils::deserializeString($data, 'schemaName', false, 'RedshiftConfigOut'),
            tableName: \Svix\Utils::deserializeString($data, 'tableName', false, 'RedshiftConfigOut')
        );
    }
