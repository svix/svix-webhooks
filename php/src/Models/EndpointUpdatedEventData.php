...
class EndpointUpdatedEventData implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \Svix\Utils::deserializeString($data, 'appId', true, 'EndpointUpdatedEventData'),
            appUid: \Svix\Utils::deserializeString($data, 'appUid', false, 'EndpointUpdatedEventData'),
            endpointId: \Svix\Utils::deserializeString($data, 'endpointId', true, 'EndpointUpdatedEventData'),
            endpointUid: \Svix\Utils::deserializeString($data, 'endpointUid', false, 'EndpointUpdatedEventData')
        );
    }
