...
class EventBridgeConfigPatch implements \JsonSerializable
{
    ...
    /**
     * Create an instance of EventBridgeConfigPatch with required fields.
     */
    ...
    {
        return new self(
            eventBusName: \Svix\Utils::deserializeString($data, 'eventBusName', false, 'EventBridgeConfigPatch'),
