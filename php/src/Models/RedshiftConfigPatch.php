...
class RedshiftConfigPatch implements \JsonSerializable
{
    ...
    /**
     * Create an instance of RedshiftConfigPatch with required fields.
     */
    ...
    public static function fromMixed(mixed $data): self
    {
        return new self(
            ...
            tableName: \Svix\Utils::deserializeString($data, 'tableName', false, 'RedshiftConfigPatch')
        );
    }
