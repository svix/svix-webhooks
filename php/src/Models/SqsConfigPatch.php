...
class SqsConfigPatch implements \JsonSerializable
{
    ...
    /**
     * Create an instance of SqsConfigPatch with required fields.
     */
    ...
    {
        return new self(
            queueUrl: \Svix\Utils::getValFromJson($data, 'queueUrl', false, 'SqsConfigPatch'),
