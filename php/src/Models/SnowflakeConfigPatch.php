...
class SnowflakeConfigPatch implements \JsonSerializable
{
    ...
    /**
     * Create an instance of SnowflakeConfigPatch with required fields.
     */
    ...
    {
        return new self(
            privateKey: \Svix\Utils::deserializeString($data, 'privateKey', false, 'SnowflakeConfigPatch'),
            accountIdentifier: \Svix\Utils::deserializeString($data, 'accountIdentifier', false, 'SnowflakeConfigPatch'),
            userId: \Svix\Utils::deserializeString($data, 'userId', false, 'SnowflakeConfigPatch'),
            dbName: \Svix\Utils::deserializeString($data, 'dbName', false, 'SnowflakeConfigPatch'),
            schemaName: \Svix\Utils::deserializeString($data, 'schemaName', false, 'SnowflakeConfigPatch'),
            tableName: \Svix\Utils::deserializeString($data, 'tableName', false, 'SnowflakeConfigPatch')
        );
    }
