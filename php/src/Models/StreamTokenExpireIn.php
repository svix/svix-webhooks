...
class StreamTokenExpireIn implements \JsonSerializable
{
     ...
     *
     * If any session ids are specified, only Stream tokens created with that
    ...
    /**
     * Create an instance of StreamTokenExpireIn with required fields.
     */
    ...
    {
        return new self(
            expiry: \Svix\Utils::deserializeInt($data, 'expiry', false, 'StreamTokenExpireIn'),
            sessionIds: \Svix\Utils::getValFromJson($data, 'sessionIds', false, 'StreamTokenExpireIn')
        );
    }
