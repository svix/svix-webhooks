...
class ListResponseIngestEndpointOut implements \JsonSerializable
{
    private array $setFields = [];

    /**
     * @param list<IngestEndpointOut> $data
     */
    ...
    /**
     * Create an instance of ListResponseIngestEndpointOut with required fields.
     */
