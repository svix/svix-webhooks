...
class IngestMessageAttemptFailingEventData implements \JsonSerializable
{
    ...
    /**
     * Create an instance of IngestMessageAttemptFailingEventData with required fields.
     */
    ...
    {
        return new self(
            endpointId: \Svix\Utils::deserializeString($data, 'endpointId', true, 'IngestMessageAttemptFailingEventData'),
            lastAttempt: \Svix\Utils::deserializeObject($data, 'lastAttempt', true, 'IngestMessageAttemptFailingEventData', [MessageAttemptFailedData::class, 'fromMixed']),
            msgEventId: \Svix\Utils::deserializeString($data, 'msgEventId', false, 'IngestMessageAttemptFailingEventData'),
            msgId: \Svix\Utils::deserializeString($data, 'msgId', true, 'IngestMessageAttemptFailingEventData'),
            sourceId: \Svix\Utils::deserializeString($data, 'sourceId', true, 'IngestMessageAttemptFailingEventData')
        );
    }
