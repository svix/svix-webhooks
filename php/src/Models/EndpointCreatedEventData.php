...
class EndpointCreatedEventData implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \Svix\Utils::deserializeString($data, 'appId', true, 'EndpointCreatedEventData'),
            appUid: \Svix\Utils::deserializeString($data, 'appUid', false, 'EndpointCreatedEventData'),
            endpointId: \Svix\Utils::deserializeString($data, 'endpointId', true, 'EndpointCreatedEventData'),
            endpointUid: \Svix\Utils::deserializeString($data, 'endpointUid', false, 'EndpointCreatedEventData')
        );
    }
