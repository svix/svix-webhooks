...
class SnsConfigIn implements \JsonSerializable
{
    ...
    public static function fromMixed(mixed $data): self
    {
        return new self(
            ...
            region: \Svix\Utils::deserializeString($data, 'region', true, 'SnsConfigIn'),
            accessKeyId: \Svix\Utils::deserializeString($data, 'accessKeyId', true, 'SnsConfigIn'),
            secretAccessKey: \Svix\Utils::deserializeString($data, 'secretAccessKey', true, 'SnsConfigIn'),
