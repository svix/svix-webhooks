...
class MessageAttemptExhaustedEventData implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \Svix\Utils::deserializeString($data, 'appId', true, 'MessageAttemptExhaustedEventData'),
            appUid: \Svix\Utils::deserializeString($data, 'appUid', false, 'MessageAttemptExhaustedEventData'),
            endpointId: \Svix\Utils::deserializeString($data, 'endpointId', true, 'MessageAttemptExhaustedEventData'),
            lastAttempt: \Svix\Utils::deserializeObject($data, 'lastAttempt', true, 'MessageAttemptExhaustedEventData', [MessageAttemptFailedData::class, 'fromMixed']),
            msgEventId: \Svix\Utils::deserializeString($data, 'msgEventId', false, 'MessageAttemptExhaustedEventData'),
            msgId: \Svix\Utils::deserializeString($data, 'msgId', true, 'MessageAttemptExhaustedEventData')
        );
    }
