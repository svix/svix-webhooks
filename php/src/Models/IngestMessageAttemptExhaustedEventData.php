...
class IngestMessageAttemptExhaustedEventData implements \JsonSerializable
{
    ...
    /**
     * Create an instance of IngestMessageAttemptExhaustedEventData with required fields.
     */
    ...
    {
        return new self(
            endpointId: \Svix\Utils::deserializeString($data, 'endpointId', true, 'IngestMessageAttemptExhaustedEventData'),
            lastAttempt: \Svix\Utils::deserializeObject($data, 'lastAttempt', true, 'IngestMessageAttemptExhaustedEventData', [MessageAttemptFailedData::class, 'fromMixed']),
            msgEventId: \Svix\Utils::deserializeString($data, 'msgEventId', false, 'IngestMessageAttemptExhaustedEventData'),
            msgId: \Svix\Utils::deserializeString($data, 'msgId', true, 'IngestMessageAttemptExhaustedEventData'),
            sourceId: \Svix\Utils::deserializeString($data, 'sourceId', true, 'IngestMessageAttemptExhaustedEventData')
        );
    }
